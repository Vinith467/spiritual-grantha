          ...
          {seriesList.map((series) => {
            ...
            return (
              <div key={series.id} className="w-full shrink-0 flex-none px-6 md:px-0">
                <div className="relative w-full overflow-hidden rounded-2xl md:rounded-none aspect-[2/3] md:aspect-[21/9] lg:aspect-[3/1] shadow-2xl select-none bg-[#0a0a0a]">
                  ...
                  {series.isLive ? (
                    ...
                    /* NORMAL CARD: Full cover image (old behavior) */
                    <>
                      <picture>
